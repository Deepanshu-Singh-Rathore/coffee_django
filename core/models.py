...
class Coffee(models.Model):
    ...
    origin = models.CharField(max_length=100, help_text="Country or region of origin")
    price = models.DecimalField(max_digits=6, decimal_places=2)
    description = models.TextField(blank=True)
    flavor_notes = models.CharField(max_length=255, blank=True, help_text="e.g., Chocolate, Caramel, Fruity")
    ...
    def __str__(self):
        return f"{self.name} ({self.get_roast_type_display()})"